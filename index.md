...
If you’re interested in exploring my latest tools, you can start with my [plugin collection]({{ '/plugins/' | relative_url }}), or check out some of my [recent projects]({{ '/projects/' | relative_url }}).
